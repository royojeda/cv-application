    ...
    return (
      <div className="flex min-h-screen w-screen text-gray-700">
        <div className="flex flex-1 items-center justify-center p-4 sm:p-10">
          <div className="flex min-h-full max-w-2xl flex-1 flex-col gap-6 border border-gray-700 p-10 shadow-md">
            <div className="general-information relative">
              <button className="absolute right-0">Edit</button>
              <div className="py-3 text-center text-4xl font-medium">
                John Doe
              </div>
